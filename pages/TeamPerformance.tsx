      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="glass-panel border border-slate-800/50 p-6 rounded-2xl">
           <div className="flex justify-between items-start mb-4">
              <span className="text-slate-400 text-xs font-bold uppercase tracking-wider">Avg Call Score</span>
              <Trophy className="text-yellow-500" size={20} />
           </div>
           <h3 className="text-3xl font-bold text-white">86.8</h3>
           <span className="text-emerald-400 text-xs font-medium flex items-center mt-2"><TrendingUp size={12} className="mr-1"/> +2.4 points</span>
        </div>
        <div className="glass-panel border border-slate-800/50 p-6 rounded-2xl">
           <div className="flex justify-between items-start mb-4">
           ...
           <h3 className="text-3xl font-bold text-white">5/6</h3>
           <span className="text-slate-500 text-xs mt-2 block">1 on leave</span>
        </div>
        <div className="glass-panel border border-slate-800/50 p-6 rounded-2xl">
           <div className="flex justify-between items-start mb-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="glass-panel border border-slate-800/50 rounded-2xl p-6 h-fit">
            ...
            <div className="space-y-2">
                <LeaderboardItem rank={1} name="James" score="92" trend={5.2} />
                <LeaderboardItem rank={2} name="David" score="90" trend={1.8} />
                <LeaderboardItem rank={3} name="Sarah" score="88" trend={-0.5} />
                <LeaderboardItem rank={4} name="Michael" score="85" trend={3.2} />
                <LeaderboardItem rank={5} name="Emily" score="79" trend={1.1} />
            </div>
